export const englishQuiz = [
  ...
  {
    number: 2,
    question: 'Municipalities in conurbation with Querétaro city',
    answers: [
  ...
  {
    number: 5,
    question: 'Queretaro City main boulevard',
    answers: [
      'Bernardo Quintana',
      'De la Nación',
      'Fray Junipero'
  ...
  {
    number: 7,
    question: 'Underground Queretaro movement from 1800’s that detonated the independence of Mexico',
    answers: [
  ...
  {
    number: 9,
    question: 'Biggest Delegation founded by 1900 revolutionary railroad men',
    answers: [
      'Centro Historico',
      'Josefa Vergara',
  ...
  {
    number: 10,
    question: 'Queretaro’s name in otomí',
    answers: [
      'Chichimecalco',
      'Maxei',
      'Querendaro'
